...
public class Cmanagercontroller extends SelectorComposer<Component> {
    ...
    public void doAfterCompose( Component comp ) {
        ...
        try {
            ...
            /**
             * public void insetdata(Component com, lista listapersona){ if(listapersona!=null){
             * 
             * Cperson loquesea = new Cperson(listapersona.id,listapersona.nombre,listapersona.apellido); dataModel.add(loquesea); insetdata(comp, lista.sig) } }
             * 
    ...
    @Listen("onAgregar=#idadd")
    public void agrega(Event event){
        Cperson person = ( Cperson ) event.getData();
        Messagebox.show( person.getComentario() );
    ...
    public void botonadd( Event event ) {
        ...
        arg.put( "agregar", idadd );
        arg.put( "personmodify", null );
        arg.put( "idmodify", null );
    ...
    public void fin( Event evento ) {
        ...
        while(i<=dataModel.getSize()){
            if(dataModel.getElementAt(i).getId() == persona.getId()){
                ...
                dataModel.getElementAt( i ).setName( persona.getName() );
                dataModel.getElementAt(i).setSecondname( persona.getSecondname() );
                dataModel.getElementAt( i ).setGenero( persona.getGenero() );
                dataModel.getElementAt( i ).setNacio( persona.getNacio() );
                dataModel.getElementAt( i ).setComentario( persona.getComentario() );
            i=dataModel.getSize();
            }
            i=i+1;
